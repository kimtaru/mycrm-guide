...
export async function generateMetadata({
  ...
  return createLlmPageMetadata({
    titleKo: "@mycrm-ui/react-table LLM Guide - 로딩 / 빈 상태",
    titleEn: "@mycrm-ui/react-table LLM Guide - Loading / Empty State",
    descriptionKo: "@mycrm-ui/react-table 로딩 / 빈 상태 파트의 LLM 가이드입니다.",
    descriptionEn: "@mycrm-ui/react-table LLM guide for the loading and empty state section.",
    pathname: "/document/react-table/llm/loading",
    searchParams,
  });
}
